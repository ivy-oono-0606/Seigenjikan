...
import com.example.seigenjikan.databinding.FragmentCommand2Binding

class Command2Fragment : Fragment() {
    private var _binding: FragmentCommand2Binding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        _binding = FragmentCommand2Binding.inflate(inflater, container, false)
        ...
        fun imagein(com:Int){
            if (i == 0){
                binding.com21.setImageResource(comin(com))
            }else if (i == 1){
                binding.com22.setImageResource(comin(com))
            }
        }
